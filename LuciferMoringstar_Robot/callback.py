...
async def cb_handler(bot, update):
    ...
    if userID == update.from_user.id:        
        ...
        if update.data == "close":
            ...
            try:
                buttons = [ [ InlineKeyboardButton("𝙷𝙾𝙼𝙴", callback_data="start"), InlineKeyboardButton("𝙷𝙾𝚆 𝚃𝙾 𝚄𝚂𝙴", callback_data="usage"), InlineKeyboardButton("𝙲𝙻𝙾𝚂𝙴", callback_data="close") ]]                     
